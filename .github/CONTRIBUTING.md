...
Thanks for your interest in contributing to Redux Promise Listener! Please take a moment
...
[issue tracker](https://github.com/erikras/redux-promise-listener/issues) to make sure
your issue hasn’t already been reported.

**We use the issue tracker to keep track of bugs and improvements** to Redux
Promise Listener itself, its examples, and the documentation. We encourage you to open
...
[StackOverflow with a `redux-promise-listener` tag](https://stackoverflow.com/questions/tagged/redux-promise-listener).
...
[an issue](https://github.com/erikras/redux-promise-listener/issues) to first discuss any
...
[.eslintrc](https://github.com/erikras/redux-promise-listener/blob/master/.eslintrc). You
...
you're adding new features to Redux Promise Listener, please include tests.
